...
class FrontendController extends Controller
{
    ...
    {
        $setting = ThemeOptions::findOrFail(1);
        $financeins = Contents::where('subcats_id', '=', 15)->get();
    ...
    {
        $setting = ThemeOptions::findOrFail(1);
        $govs = Contents::where('subcats_id', '=', 16)->get();
    ...
    {
        $setting = ThemeOptions::findOrFail(1);
        $foreigns = Contents::where('subcats_id', '=', 17)->get();
    ...
    public function professional()
    {
        ...
        return view('frontend.pages.career.professional', compact('setting', 'category'));
    }
