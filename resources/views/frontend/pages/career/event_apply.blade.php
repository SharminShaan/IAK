    ...
    <section class="about-area-two">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-md-5">
                    <h3 class="text-center" > Event Reg. Form </h3>
                    <hr>
                    ...
                    <form action="{{ route('registration.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" class="form-control" name="type_id" value="{{ $event->id }}">
                            <input type="hidden" class="form-control" name="type_name" value="{{ $event->title }}">
