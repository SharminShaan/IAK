            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/standard/index') }}">All standards</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class=" col-lx-10 col-lg-10 col-md-10">
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('standard.update', $data->id) }}" method="Post"
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('backendsite/standardimg/' . $data->logo) }}" alt="standard-logo"
                                    width="100">
                            </div>
