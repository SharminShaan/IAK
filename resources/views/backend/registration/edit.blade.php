            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/registration/index') }}">All</a></li>
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('registration.update', $data->id) }}" method="Post"
                            ...
                            <div class="mb-3">
                                ...
                                @isset($data->image)
                                    <img src="{{ asset('backendsite/registrationimg/' . $data->image) }}" alt="category-image"
                                        width="100">
                                @endisset
                            ...
                            <div class="mb-3">
                                ...
                                @isset($data->image2)
                                    <img src="{{ asset('backendsite/registrationimg/' . $data->image2) }}" alt="category-image"
                                        width="100">
                                @endisset
                            ...
                            <div class="mb-3">
                                ...
                                @isset($data->image3)
                                    <img src="{{ asset('backendsite/registrationimg/' . $data->image3) }}" alt="category-image"
                                        width="100">
                                @endisset
